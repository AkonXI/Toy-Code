...
<template>
  <div class="pie-container">
    ...
    <pie-charts v-else showOutline :echartsData="echartsData" :id="'sign-pie'" :unit="''" :showRate="false" ref="Chart"></pie-charts>
  </div>
</template>
...
export default {
  ...
  methods: {
    initData() {
      ...
      post('/tpm-act-sectioninfo/v1/statisticsSignModel', {
