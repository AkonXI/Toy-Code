...
<template>
  <div
    class="absolute top-3 right-3 z-50 w-[220px] bg-white border border-gray-200 rounded-xl shadow-lg p-3.5 text-xs"
  >
    ...
    <div v-if="result" class="mt-3 pt-2.5 border-t border-gray-200">
        ...
        <span class="flex items-center gap-1.5 font-mono font-semibold text-xs text-gray-800">
          ...
          <span
            :class="[
              ...
              result.maxErrorPass ? 'bg-green-100 text-green-600' : 'bg-red-50 text-red-600'
            ]"
          >
      ...
      <div class="flex justify-between items-center mb-1.5">
        ...
        <span class="flex items-center gap-1.5 font-mono font-semibold text-xs text-gray-800">
          ...
          <span
            :class="[
              'text-[10px] font-bold px-1.5 py-px rounded-lg uppercase',
              result.similarityPass ? 'bg-green-100 text-green-600' : 'bg-red-50 text-red-600'
            ]"
          >
      ...
      <div class="flex justify-between items-center mb-1.5">
        ...
        <span
          ...
          :class="result.violations.length > 0 ? 'text-red-600' : 'text-green-600'"
        >
