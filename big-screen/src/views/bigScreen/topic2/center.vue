<template>
  <div class="relative size-full">
    ...
    <div class="bar-container py-4">
      <bar-charts class="flex-1" :tooltipFormatter="({ name, value }) => `样本数据：${value[1]}个`" :source="source"
        :series="series" :id="'sys-project'" :yAxisName="'个'" :legend="false" ref="barChart"></bar-charts>
    </div>
  </div>
</template>
