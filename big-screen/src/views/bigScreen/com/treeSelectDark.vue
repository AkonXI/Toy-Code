<template>
  <div>
    <a-tree-select dropdownClassName="selectDownBodyDark" v-model="treeValue" :show-search="props.showSearch"
      :style="{ width: handleWidth() }" :dropdown-style="{ maxHeight: '400px', overflow: 'auto', color: '#fff' }"
      placeholder="请选择"
      :replaceFields="{ children: 'children', title: 'nodeName', key: 'nodeId', value: 'nodeId' }" :tree-data="treeData"
      :filterTreeNode="filterTreeOption" @change="change">
    </a-tree-select>
  </div>
</template>
