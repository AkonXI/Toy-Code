<template>
  <div class="grid grid-cols-3 grid-rows-2 size-full">
    <div class="h-full flex justify-center items-center" v-for="item in data">
      <div class="h-[80%] aspect-square relative">
        <span class="w-[6em] absolute top-0 left-1/2 -translate-x-1/2 flex flex-col items-center text-[16px]">
...
watch(() => props.query_fields, (value) => {
  console.log(value)
  initData();
