          ...
          <div>
            <div class="top-query">
              <yearDateDark
                ...
                @change="(e) => queryChange('year', e)"
              ></yearDateDark>
              <treeSelectDark
                :props="treeOptions"
                width="200"
                v-model="sysCompanyUuid"
                @change="(e) => queryChange('sysCompanyUuid', e)"
              >
              </treeSelectDark>
              <div class="select-wrapper" v-if="showSubCompaniesOption">
                <a-select
                  class="ant-select-dark"
                  dropdownClassName="selectDownBodyDark"
                  :allowClear="false"
                  v-model="isStatisticsChildNode"
                  @change="(e) => queryChange('isStatisticsChildNode', e)"
                  style="width: 150px"
                >
...
export default {
  components: { treeSelectDark, yearDateDark },
  props: {
    showDatePicker: {
      type: Boolean,
      default: true
